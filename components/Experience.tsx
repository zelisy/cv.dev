                ...
                <div className="space-y-12">
                    {experiences.map((exp, index) => (
                        <motion.div
                            ...
                            className="relative group border border-white/10 bg-white/5 backdrop-blur-xl rounded-3xl p-6 md:p-10 transition-all duration-500 hover:border-indigo-500/50 hover:bg-white/10"
                        >
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                                <div>
                                    ...
                                    <p className="text-indigo-400 font-medium text-lg">{exp.role[language]}</p>
                                </div>
