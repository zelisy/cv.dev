...
const timelineItems = [
  {
    ...
    description: {
      tr: "IT Sorumlusu olarak şirketin bilişim ve haberleşme altyapısının yönetimi, sistem sürekliliğinin sağlanması, ağ güvenliği ve teknik IT operasyonlarını yürütüyorum.",
      en: "As an IT Officer, I manage the company's IT and telecommunication infrastructure, system continuity, network security, and technical IT operations."
    },
  },
  {
